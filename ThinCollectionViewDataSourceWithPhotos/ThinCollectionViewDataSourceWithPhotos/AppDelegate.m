...
{
    PhotoAlbumsTableViewController *collectionVC = [[PhotoAlbumsTableViewController alloc]init];
    [_vc.navigationController pushViewController:collectionVC animated:YES];
}
