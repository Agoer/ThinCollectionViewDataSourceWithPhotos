...
@interface AtPhotoPickerDataCenter ()

@property (nonatomic , strong) ALAssetsLibrary *library;

@end

@implementation AtPhotoPickerDataCenter
...
- (void) getAllGroupAllPhotos:(BOOL)allPhotos withResource : (groupCallBackBlock) callBack{
    ...
    ALAssetsLibraryGroupsEnumerationResultsBlock resultBlock = ^(ALAssetsGroup *group, BOOL *stop){
        if (group) {
            ...
            // 包装一个模型来赋值
            AtPhotoPickerGroup *pickerGroup = [[AtPhotoPickerGroup alloc] init];
